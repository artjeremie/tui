...
for i = 1, NUM_CHAT_WINDOWS do
  ...
  local function CreateCopyButton(self)
    ...
    self.Copy:SetNormalTexture("Interface\\AddOns\\tui\\i\\chat\\copynormal")
    self.Copy:GetNormalTexture():SetSize(20, 20)
    self.Copy:SetHighlightTexture("Interface\\AddOns\\tui\\i\\chat\\copyhighlight")
